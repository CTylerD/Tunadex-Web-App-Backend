...
teacher_auth_header = {
    'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlFU'
    'aERNVVpFTmtWQk0wSTBNRGRFTnpSRU56Y3dNMFl3UXpRM09UaEdSamN5TnpkRVJUa3lSZyJ9'
    '.eyJpc3MiOiJodHRwczovL2ZzbmRjdGQuYXV0aDAuY29tLyIsInN1YiI6ImF1dGgwfDVlNmR'
    'mZTlkMTA4ODViMGNhNmE5YzYwYyIsImF1ZCI6InR1bmFkZXgiLCJpYXQiOjE1OTA4NjQyNzk'
    'sImV4cCI6MTU5MDk1MDY3OSwiYXpwIjoiV0pzQTdSc0dDbEZoOTV4ZG1JMFE3UjJ5SXk3OFF'
    'ISGYiLCJzY29wZSI6IiIsInBlcm1pc3Npb25zIjpbImRlbGV0ZTpzZXRsaXN0IiwiZGVsZXR'
    'lOnR1bmVzIiwiZ2V0OnNldGxpc3QiLCJnZXQ6dHVuZXMiLCJwYXRjaDpzZXRsaXN0IiwicGF'
    '0Y2g6dHVuZXMiLCJwb3N0OnNldGxpc3QiLCJwb3N0OnR1bmVzIl19.KReJOWxzzRawoYm52s'
    'Rr69TdwQFwn97Jeo_C0DdHhHsg4ha22Ak-FHLoIrIYUy5gp2YxQaQ69gxQOjmnoSlY4_hwfZ'
    'jSfEXdzcU3WjhGD94G3t2LbuH1E1uBcZU7acw2Dp2naE0IscMqEdmncSxBRd1Dsle6rawkz_'
    'vEKISo-EqYTdD-YeWSusouEEeVZx8sRxh7PAdUXfIG533bZEdSUTxf52vtmI5ZsRnYLQzhqd'
    'wzM8fdtCtVcj7lUXKvzBTAxt-hwMlLptaiE1Nw4xzGAUigxuGiFkY4vY30TOE3h8rjCcErQH'
    '8-r1W1EYZioq6b7sgLqWxdTkJ61x5paDFlHA'
}

student_auth_header = {
    'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlFU'
    'aERNVVpFTmtWQk0wSTBNRGRFTnpSRU56Y3dNMFl3UXpRM09UaEdSamN5TnpkRVJUa3lSZyJ9'
    '.eyJpc3MiOiJodHRwczovL2ZzbmRjdGQuYXV0aDAuY29tLyIsInN1YiI6ImF1dGgwfDVlYzZ'
    'lYzE0ZDY2ZTFjMGJmNDUzMGM4ZSIsImF1ZCI6InR1bmFkZXgiLCJpYXQiOjE1OTA4NjQxODE'
    'sImV4cCI6MTU5MDk1MDU4MSwiYXpwIjoiV0pzQTdSc0dDbEZoOTV4ZG1JMFE3UjJ5SXk3OFF'
    'ISGYiLCJzY29wZSI6IiIsInBlcm1pc3Npb25zIjpbImdldDpzZXRsaXN0IiwiZ2V0OnR1bmV'
    'zIl19.hijClFAtRnd6jrM7xSTDhFWvllgYjnCj11YExK-PQzWclpTLr4VwM3Ixxy58oiwZdo'
    'Xjw5Pw1TN4U_2xoKQRSFX7KiXL9q4M9EzgSOGy2jFWa3_z_3Lj1EHed0NQq-9Z2av84VJj9m'
    'f67jN2z_62qHZVHtePFqUI8mjCHfW9ZYVkKgnd3u2mi_n1hxDpms_DB6fA1DCLPI5JfOJwMg'
    'sUyNiKs4igFnD4xs_CTIA5mWiqOB1cUklE0m0uHc9-LSlJ5TM03WJ99bRFtfhPv0mIOw9BKo'
    'tWAldZugyAobSAyD2BTp8jq2_Dr1CEeq5abSNHraQgfXbqTLvRi_HN_ZzpNA'
}
